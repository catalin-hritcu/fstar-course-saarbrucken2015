...
(* TODO: Write down some types for canRead and canWrite that are
         sufficiently precise to allow the program to continue to
         type-check. More details about the exercise in sections 1
         and 8.1 of the F* tutorial. *)
